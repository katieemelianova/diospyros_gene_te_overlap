...
#####################################################################################
sed -i 's/yahouensis_tig//g' braker_gene.gtf
...
cut -f 10,13,14 $species.gene_helitron_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_helitron_window$window.te.fasta
cut -f 10,13,14 $species.gene_cactaTIR_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_cactaTIR_window$window.te.fasta
cut -f 10,13,14 $species.gene_harbingerTIR_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_harbingerTIR_window$window.te.fasta
cut -f 10,13,14 $species.gene_marinerTIR_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_marinerTIR_window$window.te.fasta
cut -f 10,13,14 $species.gene_mutatorTIR_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_mutatorTIR_window$window.te.fasta
cut -f 10,13,14 $species.gene_copiaLTR_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_copiaLTR_window$window.te.fasta
cut -f 10,13,14 $species.gene_gypsyLTR_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_gypsyLTR_window$window.te.fasta

cut -f 1,4,5 $species.gene_helitron_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_helitron_window$window.gene.fasta
cut -f 1,4,5 $species.gene_cactaTIR_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_cactaTIR_window$window.gene.fasta
cut -f 1,4,5 $species.gene_harbingerTIR_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_harbingerTIR_window$window.gene.fasta
cut -f 1,4,5 $species.gene_marinerTIR_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_marinerTIR_window$window.gene.fasta
cut -f 1,4,5 $species.gene_mutatorTIR_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_mutatorTIR_window$window.gene.fasta
cut -f 1,4,5 $species.gene_copiaLTR_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_copiaLTR_window$window.gene.fasta
cut -f 1,4,5 $species.gene_gypsyLTR_window$window.gff3 | sed 's/^/yahouensis_tig/' | bedtools getfasta -fi $species.fasta -bed stdin > $species.gene_gypsyLTR_window$window.gene.fasta
